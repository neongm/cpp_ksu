...
int main(){
    int dates[6];
    int out;
    std::string answers[3] = {"вторая дата больше", "первая дата больше","даты идентичны"};
    std::cout<<"введите последовательно год 1, месяц 1, день 1, год 2, месяц 2, день 2 "<<std::endl;
